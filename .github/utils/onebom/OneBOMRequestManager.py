...
class OneBOMRequestManager:
    ...
    VARIANT_DETAILS_ENDPOINT = (
        "https://apis-internal.intel.com/item/v1/software-variant-details"
    )
    RELEASE_DETAILS_ENDPOINT = (
        "https://apis-internal.intel.com/item/v1/software-release-details"
    )
    ...
    def get(self, url, **kwargs):
        return self._session.get(
            url, proxies=self.get_proxies(), headers=self.get_headers(), **kwargs
        )
